...
The Maven group-id is defaulted to **de.jena.simulator** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `de.jena.simulator`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `de.jena.simulator` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/de.jena.simulator/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/de.jena.simulator.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/de.jena.simulator/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `de.jena.simulator`
- [Jenkins de.jena.simulator branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/de.jena.simulator/)
